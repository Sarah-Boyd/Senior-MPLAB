...
void read_imu(int *data){
    ...
    data[0] = acc_x2|(acc_x1 << 8);
    data[1] = acc_y2|(acc_y1 << 8);
    data[2] = acc_z2|(acc_z1 << 8);
    data[3] = gyr_x2|(gyr_x1 << 8);
    data[4] = gyr_y2|(gyr_y1 << 8);
    data[5] = gyr_z2|(gyr_z1 << 8);
