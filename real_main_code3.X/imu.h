...
void read_imu(void){
    ...
    imu_data[0] = ((acc_x2<<8) + acc_x1)/100;
    imu_data[1] = ((acc_y2<<8) + acc_y1)/100;
    imu_data[2] = ((acc_z2<<8) + acc_z1)/100;
    imu_data[3] = ((gyr_x2<<8) + gyr_x1-gyro_factor*((gyr_z2<<8)+gyr_z1)/pow(2,9))/100;
    imu_data[4] = ((gyr_y2<<8) + gyr_y1)/100;
    imu_data[5] = ((gyr_z2<<8) + gyr_z1)/100;
}
