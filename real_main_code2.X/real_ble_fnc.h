...
void Setup(void){
    // Pin configurations
    TRISBbits.TRISB13 = 0; // set WIFI/BT enable to a digital output
    //TRISBbits.TRISB10 = 0; // set WIFI/BT reset to a digital output
    ANSELAbits.ANSELA2 = 0; // set as digital
    TRISAbits.TRISA2 = 1; // set as a digital input
    ...
    // Enable WIFI/BT
    LATBbits.LATB13 = 1; // enable WIFI/BT pin 
    // Enable UART
